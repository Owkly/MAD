...
arbre <- rpart(remote_allowed ~ ., data = data.train)
...
accuracy_values <- c(accuracy_lda, accuracy_qda, accuracy_cart, accuracy_rf, accuracy_logit_lasso)
auc_values <- c(roc_lda$auc, roc_qda$auc, roc_cart$auc, roc_rf$auc, ROC_logit_lasso$auc)
...
# accuracy 0.8929487 0.8865385 0.8929487 0.9051282   0.8294872
# AUC      0.8109529 0.8160165 0.7097420 0.7485243   0.7155322
# [1] "Modèle avec meilleur accuracy:  RF"
# [1] "Modèle avec meilleur AUC:  qda"
...
# 
#                lda       qda      cart        RF logit_lasso
# accuracy 0.8750000 0.8743590 0.8467949 0.8653846   0.7967949
# AUC      0.7578012 0.7639931 0.7485064 0.7814241   0.7097750
# [1] "Modèle avec meilleur accuracy:  lda"
# [1] "Modèle avec meilleur AUC:  RF"
```
